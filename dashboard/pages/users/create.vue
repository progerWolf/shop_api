  ...
  <div class="px-6">
    <div class="w-full py-8">
      <div class="flex items-center justify-between w-full">
        ...
        <div class="flex">
          <nuxt-link to="/clients" class="d-btn d-btn-primary">
            ...
            <div class="flex flex-wrap w-full">
              ...
              <div class="w-full lg:w-1/3 md:w-1/2 md:px-3 py-2">
                ...
                <div class="mt-1 flex">
                  ...
                  <input v-model="user.phone" type="tel" required="" maxlength="9"
...
<!--                </label>-->
<!--                <div class="mt-1">-->
<!--                  <v-select multiple v-model="user.roles" :options="roles" label="display_name" />-->
...
export default {
  ...
  methods: {
    ...
    save() {
      this.$axios.post('/dashboard/clients', this.user.user_type ? this.user : this.user)
          .then(res => {
            this.$swal({
              icon: 'success',
              title: 'Успешно',
