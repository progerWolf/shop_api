            ...
            <div class="flex flex-wrap w-full">
              ...
              <div class="w-full lg:w-1/3 md:w-1/2 md:px-3 py-2">
                ...
                <div class="mt-1 flex">
                  ...
                  <input v-model="employer.phone" type="tel" required="" maxlength="9" disabled
...
export default {
  ...
  methods: {
    init() {
      this.$axios.get(`/dashboard/employees/${this.$route.params.id}`)
      .then(res=> {
    ...
    save() {
      this.$axios.put(`/dashboard/employees/${this.employer.id}`, this.employer)
      .then(res=> {
        this.$swal({
          icon: 'success',
          title: 'Успешно',
