        ...
        <form class="space-y-4" @submit.prevent="submit">
          ...
          <template v-if="showRegister">
            <div>
              ...
              <div class="mt-1">
                <input v-model="register.name" id="name" name="name" type="text" autocomplete="current-password" required="" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
              </div>
            </div>
